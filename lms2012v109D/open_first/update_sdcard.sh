...
then
	...
	cd ${current}
        ...
        sudo cp -r ~/projects/lms2012v109D/lms2012/Linux_AM1808/* /media/LMS2012_EXT/home/root/lms2012

        echo "  ...."copying.testprograms.to.sdcard
        sudo cp -r ~/projects/lms2012v109D/lmssrc/Test/Test /media/LMS2012_EXT/home/root/lms2012/prjs/
